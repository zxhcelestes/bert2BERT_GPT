...
from src.pytorch_version.load_pretrain_model import load_GPT_base as ld_py, enlarge as enlarge_py, \
    pre_defined_GPT_config as config_py
from src.mindspore_version.load_pretrain_model import load_GPT_base as ld_ms, enlarge as enlarge_ms, \
...
class PytorchEnlarger:
    ...
    # model = load_gpt_base(ckpt_path, "gpt_base", load_gitee_ckpt=True, specify_prefix="gpt.gpt")
    ...
    def gpt_medium2large_aki():
        ...
        if not os.path.exists(save_path):
            model = ld_py(ckpt_path, "gpt_medium", load_gitee_ckpt=True, specify_prefix="gpt.gpt")
