...
if __name__ == '__main__':
    ...
    for name, module in enumerate(childs_name.keys()):
        print(name, "-->", module)

    for name in childs_name:
        for params in childs_name.get(name).get_parameters():
            print("Name: ", params.name, params.value())
